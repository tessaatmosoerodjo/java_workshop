...
//        StudentGenderFactory studentGenderFactory = new StudentGenderFactory();
//        StudentGender obj = studentGenderFactory.getInstance("uib");
//        obj.gender();
...
//                        }
                        ...
                        if (save.equals("Y")) {
                            System.out.println("Application is being processed");
        ...
        //student
                    ...
                    if (save.equals("Y")) {
                        ...
                        Student student = new Student(lastname, firstname, dateOfBirth, gender, telephone_number);

                        Student student1 = studentDAO.createStudent(student);
                        ...
                        if (moreAddress.equals("Y")) {
                            ...
                            System.out.print("Enter your Streetname: ");
                            String streetnam2 = userInput.next();


                            // connect addres met student

                            Address address2 = addressDAO.selectAddressByStreetname(streetname1);
                        ...
                        if (save.equals("Y")) {
                            ...
                            System.out.println("Application has a status");
                        }
